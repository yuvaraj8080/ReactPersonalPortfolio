  ...
  return (
    ...
    >
      <Container className="z-[1] flex items-center justify-center">
        ...
        >
          <motion.h1
            className="m-0 w-full max-w-full font-display text-4xl font-bold leading-[1.2] tracking-[-0.02em] text-text-primary transition-colors duration-300 max-[768px]:text-2xl"
          ...
          >
            ...
            <motion.a
              href="mailto:yuvarajdekhane8080@gmail.com"
              className={socialLinkClasses}
              aria-label="Email"
